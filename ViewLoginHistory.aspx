<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewLoginHistory.aspx.cs" Inherits="UserHome" %>
    ...
    <div id="wrapper" runat="server">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active"><i class="glyphicon glyphicon-time"></i> View User Log in History</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Login History</h1>
                        <form runat="server">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT [Username], [Logintime] FROM [DeDup].[dbo].[LoginHistory]">
                            </asp:SqlDataSource>
