<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewUserFiles.aspx.cs" Inherits="UserHome" %>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active"><i class="fa fa-tasks fa-fw"></i> View User Files</a>
                        </li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="oname" HeaderText="Username" 
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT [Fid], [filename], [ftype], [fsize],[oname],[date] FROM [DeDup].[dbo].[FileUp]">
                            </asp:SqlDataSource>
                            </form>
                    </div>
                    <!-- /.col-lg-12 -->
